...
function engineInit(gameInit, gameUpdate, gameUpdatePost, gameRender, gameRenderPost, tileImageSource)
{
    ...
    function engineUpdate(frameTimeMS=0)
    {
        ...
        if (showWatermark)
        {
            ...
            const text = engineName$1 + ' ' + 'v' + engineVersion + ' / ' 
...
let debugPrimitives = [], downloadLink;
 ...
 *  @param {Object}  output
 *  @memberof Debug */
const ASSERT$1 = (...assert)=> console.assert(...assert) ;
 ...
 *  @memberof Debug */
const debugRect$1 = (pos, size=vec2(), color='#fff', time=0, angle=0, fill=false)=> 
{
    ASSERT$1(typeof color == 'string'); // pass in regular html strings as colors
 ...
 *  @param {Number}  [angle=0]
 *  @memberof Debug */
const debugPoint$1 = (pos, color, time, angle)=> debugRect$1(pos, 0, color, time, angle);
 ...
 *  @param {Number}  [time=0]
 *  @memberof Debug */
const debugLine$1 = (posA, posB, color, thickness=.1, time)=>
{
    const halfDelta = vec2((posB.x - posA.x)/2, (posB.y - posA.y)/2);
    const size = vec2(thickness, halfDelta.length()*2);
    debugRect$1(posA.add(halfDelta), size, color, time, halfDelta.angle(), 1);
};
 ...
 *  @param {String}  [color='#fff']
 *  @memberof Debug */
const debugAABB$1 = (pA, sA, pB, sB, color)=>
{
    const minPos = vec2(min(pA.x - sA.x/2, pB.x - sB.x/2), min(pA.y - sA.y/2, pB.y - sB.y/2));
    const maxPos = vec2(max(pA.x + sA.x/2, pB.x + sB.x/2), max(pA.y + sA.y/2, pB.y + sB.y/2));
    debugRect$1(minPos.lerp(maxPos,.5), maxPos.subtract(minPos), color);
};
 ...
 *  @return {Vector2}
 *  @memberof Random */
const randInCircle$1 = (radius=1, minRadius=0)=> radius > 0 ? randVector$1(radius * rand$1(minRadius / radius, 1)**.5) : new Vector2$1;

/** Returns a random Vector2 with the passed in length
 *  @param {Number} [length=1]
 *  @return {Vector2}
 *  @memberof Random */
const randVector$1 = (length=1)=> new Vector2$1().setAngle(rand$1(2*PI$1), length);
 ...
 *  @return {Color}
 *  @memberof Random */
const randColor$1 = (cA = new Color$1, cB = new Color$1(0,0,0,1), linear)=>
    linear ? cA.lerp(cB, rand$1()) : new Color$1(rand$1(cA.r,cB.r),rand$1(cA.g,cB.g),rand$1(cA.b,cB.b),rand$1(cA.a,cB.a));
 ...
 * @memberof Utilities
 */
const vec2$1 = (x=0, y)=> x.x == undefined ? new Vector2$1(x, y == undefined? x : y) : new Vector2$1(x.x, x.y);
 ...
 * @memberof Utilities
 */
const rgb = (r, g, b, a)=> new Color$1(r, g, b, a);
 ...
 * @memberof Utilities
 */
const hsl = (h, s, l, a)=> new Color$1().setHSLA(h, s, l, a);
