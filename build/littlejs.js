var LittleJS = (function (exports) {
     ...
     *  @param {Number} seed
     *  @memberof Random */
    const setRandSeed = (seed)=> exports.randSeed = seed;
    ...
    {
        exports.randSeed ^= exports.randSeed << 13; exports.randSeed ^= exports.randSeed >>> 17; exports.randSeed ^= exports.randSeed << 5; // xorshift
        return b + (a-b) * abs$1(exports.randSeed % 1e9) / 1e9;
    };
     ...
     *  @type {Array}
     *  @memberof Engine */
    exports.engineObjects = [];

    /** Array containing only objects that are set to collide with other objects this frame (for optimization)
     *  @type {Array}
     *  @memberof Engine */
    exports.engineObjectsCollide = [];
     ...
     *  @memberof Engine */
    function setPaused(_paused) { exports.paused = _paused; }
    ...
    function engineInit(gameInit, gameUpdate, gameUpdatePost, gameRender, gameRenderPost, tileImageSource) {
        ...
        function engineUpdate(frameTimeMS = 0) {
            ...
            exports.timeReal += frameTimeDeltaMS / 1e3;
            frameTimeBufferMS += !exports.paused * frameTimeDeltaMS;
            if (!debugSpeedUp)
            ...
            enginePreRender$1();
            gameRender();
            exports.engineObjects.sort((a, b) => a.renderOrder - b.renderOrder);
            for (const o of exports.engineObjects)
            ...
            if (showWatermark) {
                ...
                const text = engineName + ' ' + 'v' + engineVersion + ' / '
                    + drawCount + ' / ' + exports.engineObjects.length + ' / ' + averageFPS.toFixed(1)
                    + (glEnable ? ' GL' : ' 2D');
    ...
    function engineObjectsUpdate() {
        ...
        exports.engineObjectsCollide = exports.engineObjects.filter(o => o.collideSolidObjects);
        ...
        exports.engineObjects = exports.engineObjects.filter(o => !o.destroyed);

        // increment frame and update time
        exports.time = ++exports.frame / frameRate;
    }
     ...
     *  @memberof Engine */
    function engineObjectsCallback(pos, size, callbackFunction, objects = exports.engineObjects) {
        if (!pos) // all objects
        {
    ...
    function playSamples(sampleChannels, volume=1, rate=1, pan=0, loop=0) 
    {
        ...
        // fix stalled audio
        exports.audioContext.resume();

        // prevent sounds from building up if they can't be played
        if (exports.audioContext.state != 'running')
            return;

        // create buffer and source
        const buffer = exports.audioContext.createBuffer(sampleChannels.length, sampleChannels[0].length, zzfxR), 
            source = exports.audioContext.createBufferSource();
        ...
        const gainNode = exports.audioContext.createGain();
        gainNode.gain.value = soundVolume*volume;
        gainNode.connect(exports.audioContext.destination);

        // connect source to stereo panner and gain
        source.connect(new StereoPannerNode(exports.audioContext, {'pan':clamp(pan, -1, 1)})).connect(gainNode);
    ...
    exports.engineFontImage = void 0;
     ...
     *  @type {Vector2}
     *  @memberof Input */
    exports.mousePosScreen = vec2();

    /** Mouse wheel delta this frame
     *  @type {Number}
     *  @memberof Input */
    exports.mouseWheel = 0;

    /** Returns true if user is using gamepad (has more recently pressed a gamepad button)
     *  @type {Boolean}
     *  @memberof Input */
    exports.isUsingGamepad = 0;
    ...
    onkeydown = (e)=>
    {
        ...
        e.repeat || (inputData[exports.isUsingGamepad = 0][remapKey(e.which)] = 3);
    };
    onkeyup = (e)=>
    {
        if (debug && e.target != document.body) return;
    ...
    onmousedown = (e)=> {inputData[exports.isUsingGamepad = 0][e.button] = 3; onmousemove(e); e.button && e.preventDefault();};
    onmouseup   = (e)=> inputData[0][e.button] = inputData[0][e.button] & 2 | 4;
    onmousemove = (e)=> exports.mousePosScreen = mouseToScreen(e);
    onwheel = (e)=> e.ctrlKey || (exports.mouseWheel = sign(e.deltaY));
        ...
        for (let i = gamepads.length; i--;)
        {
            ...
            if (gamepad)
            {
                ...
                for (let j = gamepad.buttons.length; j--;)
                {
                    ...
                    exports.isUsingGamepad |= !i && button.pressed;
    ...
    exports.tileCollision = [];

    /** Size of the tile collision layer
     *  @type {Vector2} 
     *  @memberof TileCollision */
    exports.tileCollisionSize = vec2();
    ...
    {
        exports.tileCollisionSize = size;
        exports.tileCollision = [];
        for (let i=exports.tileCollision.length = exports.tileCollisionSize.area(); i--;)
            exports.tileCollision[i] = 0;
    }
    ...
    const setTileCollisionData = (pos, data=0)=>
        pos.arrayCheck(exports.tileCollisionSize) && (exports.tileCollision[(pos.y|0)*exports.tileCollisionSize.x+pos.x|0] = data);
    ...
    const getTileCollisionData = (pos)=>
        pos.arrayCheck(exports.tileCollisionSize) ? exports.tileCollision[(pos.y|0)*exports.tileCollisionSize.x+pos.x|0] : 0;
    ...
    function tileCollisionTest$1(pos, size=vec2(), object)
    {
        ...
        const maxX = min(pos.x + size.x/2, exports.tileCollisionSize.x);
        const maxY = min(pos.y + size.y/2, exports.tileCollisionSize.y);
        for (let y = minY; y < maxY; ++y)
        for (let x = minX; x < maxX; ++x)
        {
            const tileData = exports.tileCollision[y*exports.tileCollisionSize.x+x];
    ...
    /** Create a tile layer object
        ...
        *  @param {Number}  [renderOrder=0]            - Objects sorted by renderOrder before being rendered
        */
    constructor(pos, size=exports.tileCollisionSize, tileSize=tileSizeDefault, scale=vec2(1), renderOrder=0)
        {
    ...
    exports.Color = Color;
    exports.EngineObject = EngineObject$1;
    exports.FontImage = FontImage;
    exports.Medal = Medal;
    exports.Music = Music;
    ...
    exports.TileLayerData = TileLayerData;
    exports.Timer = Timer;
    exports.Vector2 = Vector2;
    exports.abs = abs$1;
    exports.cameraPos = cameraPos$1;
    exports.cameraScale = cameraScale$1;
    exports.canvasFixedSize = canvasFixedSize$1;
    exports.canvasMaxSize = canvasMaxSize$1;
    exports.cavasPixelated = cavasPixelated$1;
    exports.clamp = clamp$1;
    exports.clearInput = clearInput;
    exports.drawCanvas2D = drawCanvas2D;
    exports.drawLine = drawLine;
    exports.drawRect = drawRect;
    exports.drawRectScreenSpace = drawRectScreenSpace;
    exports.drawText = drawText;
    exports.drawTextScreen = drawTextScreen$1;
    exports.drawTile = drawTile$1;
    exports.drawTileScreenSpace = drawTileScreenSpace;
    exports.enablePhysicsSolver = enablePhysicsSolver$1;
    exports.engineInit = engineInit;
    exports.engineName = engineName;
    exports.engineObjectsCallback = engineObjectsCallback;
    exports.engineObjectsDestroy = engineObjectsDestroy;
    exports.engineObjectsUpdate = engineObjectsUpdate;
    exports.engineVersion = engineVersion;
    exports.fontDefault = fontDefault$1;
    exports.formatTime = formatTime;
    exports.frameRate = frameRate;
    exports.gamepadDirectionEmulateStick = gamepadDirectionEmulateStick$1;
    exports.gamepadIsDown = gamepadIsDown;
    exports.gamepadStick = gamepadStick;
    exports.gamepadWasPressed = gamepadWasPressed;
    exports.gamepadWasReleased = gamepadWasReleased;
    exports.gamepadsEnable = gamepadsEnable$1;
    exports.gamepadsUpdate = gamepadsUpdate;
    exports.getNoteFrequency = getNoteFrequency;
    exports.getTileCollisionData = getTileCollisionData;
    exports.glCanvas = glCanvas$1;
    exports.glCompileShader = glCompileShader;
    exports.glContext = glContext;
    exports.glCreateProgram = glCreateProgram;
    exports.glCreateTexture = glCreateTexture;
    exports.glEnable = glEnable$1;
    exports.glInitPostProcess = glInitPostProcess;
    exports.glOverlay = glOverlay$1;
    exports.glSetBlendMode = glSetBlendMode$1;
    exports.glSetTexture = glSetTexture;
    exports.glTileTexture = glTileTexture;
    exports.gravity = gravity$1;
    exports.hsl = hsl;
    exports.initTileCollision = initTileCollision;
    exports.inputWASDEmulateDirection = inputWASDEmulateDirection$1;
    exports.isFullscreen = isFullscreen;
    exports.isOverlapping = isOverlapping$1;
    exports.isTouchDevice = isTouchDevice;
    exports.isVector2 = isVector2$1;
    exports.keyIsDown = keyIsDown$1;
    exports.keyWasPressed = keyWasPressed;
    exports.keyWasReleased = keyWasReleased;
    exports.lerp = lerp$1;
    exports.mainCanvas = mainCanvas$1;
    exports.mainCanvasSize = mainCanvasSize$1;
    exports.mainContext = mainContext$1;
    exports.max = max$1;
    exports.medalDisplayIconSize = medalDisplayIconSize$1;
    exports.medalDisplaySize = medalDisplaySize$1;
    exports.medalDisplaySlideTime = medalDisplaySlideTime$1;
    exports.medalDisplayTime = medalDisplayTime$1;
    exports.medalsInit = medalsInit;
    exports.medalsPreventUnlock = medalsPreventUnlock$1;
    exports.min = min$1;
    exports.mod = mod;
    exports.mouseIsDown = mouseIsDown;
    exports.mousePos = mousePos;
    exports.mouseToScreen = mouseToScreen;
    exports.mouseWasPressed = mouseWasPressed;
    exports.mouseWasReleased = mouseWasReleased;
    exports.nearestPowerOfTwo = nearestPowerOfTwo;
    exports.newgroundsInit = newgroundsInit;
    exports.objectDefaultAngleDamping = objectDefaultAngleDamping$1;
    exports.objectDefaultDamping = objectDefaultDamping$1;
    exports.objectDefaultElasticity = objectDefaultElasticity$1;
    exports.objectDefaultFriction = objectDefaultFriction$1;
    exports.objectDefaultMass = objectDefaultMass$1;
    exports.objectMaxSpeed = objectMaxSpeed$1;
    exports.overlayCanvas = overlayCanvas$1;
    exports.overlayContext = overlayContext$1;
    exports.particleEmitRateScale = particleEmitRateScale$1;
    exports.percent = percent$1;
    exports.playAudioFile = playAudioFile;
    exports.playSamples = playSamples;
    exports.preventDefaultInput = preventDefaultInput;
    exports.rand = rand$1;
    exports.randColor = randColor$1;
    exports.randInCircle = randInCircle$1;
    exports.randInt = randInt$1;
    exports.randSeeded = randSeeded;
    exports.randSign = randSign$1;
    exports.randVector = randVector$1;
    exports.rgb = rgb;
    exports.screenToWorld = screenToWorld;
    exports.setBlendMode = setBlendMode$1;
    exports.setCameraPos = setCameraPos;
    exports.setCameraScale = setCameraScale;
    exports.setCanvasFixedSize = setCanvasFixedSize;
    exports.setCanvasMaxSize = setCanvasMaxSize;
    exports.setCavasPixelated = setCavasPixelated;
    exports.setDebugKey = setDebugKey;
    exports.setEnablePhysicsSolver = setEnablePhysicsSolver;
    exports.setFontDefault = setFontDefault;
    exports.setGamepadDirectionEmulateStick = setGamepadDirectionEmulateStick;
    exports.setGamepadsEnable = setGamepadsEnable;
    exports.setGlEnable = setGlEnable;
    exports.setGlOverlay = setGlOverlay;
    exports.setGodMode = setGodMode;
    exports.setGravity = setGravity;
    exports.setInputWASDEmulateDirection = setInputWASDEmulateDirection;
    exports.setMedalDisplayIconSize = setMedalDisplayIconSize;
    exports.setMedalDisplaySize = setMedalDisplaySize;
    exports.setMedalDisplaySlideTime = setMedalDisplaySlideTime;
    exports.setMedalDisplayTime = setMedalDisplayTime;
    exports.setMedalsPreventUnlock = setMedalsPreventUnlock;
    exports.setObjectDefaultAngleDamping = setObjectDefaultAngleDamping;
    exports.setObjectDefaultDamping = setObjectDefaultDamping;
    exports.setObjectDefaultElasticity = setObjectDefaultElasticity;
    exports.setObjectDefaultFriction = setObjectDefaultFriction;
    exports.setObjectDefaultMass = setObjectDefaultMass;
    exports.setObjectMaxSpeed = setObjectMaxSpeed;
    exports.setParticleEmitRateScale = setParticleEmitRateScale;
    exports.setPaused = setPaused;
    exports.setRandSeed = setRandSeed;
    exports.setShowWatermark = setShowWatermark;
    exports.setSoundDefaultRange = setSoundDefaultRange;
    exports.setSoundDefaultTaper = setSoundDefaultTaper;
    exports.setSoundEnable = setSoundEnable;
    exports.setSoundVolume = setSoundVolume;
    exports.setTileCollisionData = setTileCollisionData;
    exports.setTileFixBleedScale = setTileFixBleedScale;
    exports.setTileSizeDefault = setTileSizeDefault;
    exports.setTouchGamepadAlpha = setTouchGamepadAlpha;
    exports.setTouchGamepadAnalog = setTouchGamepadAnalog;
    exports.setTouchGamepadEnable = setTouchGamepadEnable;
    exports.setTouchGamepadSize = setTouchGamepadSize;
    exports.setVibrateEnable = setVibrateEnable;
    exports.sign = sign$1;
    exports.smoothStep = smoothStep;
    exports.soundDefaultRange = soundDefaultRange$1;
    exports.soundDefaultTaper = soundDefaultTaper$1;
    exports.soundEnable = soundEnable$1;
    exports.soundVolume = soundVolume$1;
    exports.speak = speak;
    exports.speakStop = speakStop;
    exports.tileCollisionRaycast = tileCollisionRaycast;
    exports.tileCollisionTest = tileCollisionTest$1;
    exports.tileFixBleedScale = tileFixBleedScale$1;
    exports.tileImage = tileImage$1;
    exports.tileSizeDefault = tileSizeDefault$1;
    exports.timeDelta = timeDelta$1;
    exports.toggleFullscreen = toggleFullscreen;
    exports.touchGamepadAlpha = touchGamepadAlpha$1;
    exports.touchGamepadAnalog = touchGamepadAnalog$1;
    exports.touchGamepadEnable = touchGamepadEnable$1;
    exports.touchGamepadSize = touchGamepadSize$1;
    exports.vec2 = vec2;
    exports.vibrate = vibrate;
    exports.vibrateEnable = vibrateEnable$1;
    exports.vibrateStop = vibrateStop;
    exports.wave = wave;
    exports.worldToScreen = worldToScreen$1;
    exports.zzfx = zzfx$1;
