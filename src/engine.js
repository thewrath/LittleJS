...
import {
    canvasMaxSize,
    canvasFixedSize,
    cavasPixelated, tileFixBleedScale, glEnable
...
import {
    min, lerp, isOverlapping, Vector2,
    vec2
 ...
 *  @default
 *  @memberof Engine */
export const engineVersion = '1.6.3';
 ...
 *  @memberof Engine */
export function setPaused(_paused) { paused = _paused; }
